...
| 'oauth-server' Use a OAUTH2 library
|
| Note: If 'rest_auth' is set to 'session' then change 'auth_source' to the name of the session variable
/ Note: If 'rest_auth' is set to 'oauth' then change 'auth_source' to the name of the oauth-server variable
|
*/


$config['auth_source'] = 'oauth-server';
...
|
| e.g: md5('admin_bak:REST API:1234') = '1e957ebc35631ab22d5bd6526bd14ea2'
|
*/
...
|
*/
$config['rest_valid_logins'] = ['admin_bak' => '1234'];
