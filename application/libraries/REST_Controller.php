...
abstract class REST_Controller extends CI_Controller {
    ...
    private function  get_profile(){
        if (isset($this->_user_id) && $this->_user_id > 0  ){
            ...
            return $this->Usermodel->getProfile($this->_user_id);
    ...
    protected function _check_oauth_server()
    {
            ...
            if( isset($access_token) && !empty($access_token) && isset($openid) && !empty($openid)){

                $ret =  $this->checkAccessToken($access_token, $openid);
    ...
    protected function _force_login($nonce = '')
    {
        ...
        }elseif(strtolower($rest_auth) === 'oauth'){        //added by loudon 2018-04-02
            $this->response([
                'status' => FALSE,
